    ...
    <div {...getRootProps()}>
      {image ? (
        <div className="flex flex-col items-center gap-3 lg:flex-row">
          ...
          >
            <Icons.trash className="h-5 w-5 fill-secondary" />
          </Button>
        </div>
      ) : (
        <div className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-lg border-2 border-dashed bg-secondary p-3">
          <input {...getInputProps()} />
